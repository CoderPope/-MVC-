          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="<%=path%>/CourseServlet?operate=allCourseQuery&href=management">课程信息管理</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <%
       ...
       if(allCourseList==null){
       		response.sendRedirect(""+path+"/CourseServlet?operate=allCourseQuery&href=management");
       }
       else{
       		int pageSize = 10;
          ...
          <section class="wrapper">
                          ...
                          <form action="<%=path%>/CourseServlet">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <%
         						...
         						Course courseInfo = (Course)allCourseList.get(i); 
         					  %>
                              <tr>
                              	  ...
                              	  <td class="numeric"><%=courseInfo.getCredit() %></td>
                              	  <td class="numeric"><%=courseInfo.getType() %></td>                                  
                                  <td class="numeric"><span class="badge bg-theme04"><i class="fa fa-trash-o "><a href="<%=path%>/CourseServlet?operate=delete&Cno=<%=courseInfo.getCno()%>">删除</a></i></span></td>
                              </tr>
                              <%} %>
                                                         
                              </tbody>
                          </table>
                          <span class="btn btn-warning btn-lg"><a href="<%=path%>/CourseServlet?operate=updateQuery">批量修改</a></span>
        	...
        	<table  align="right" width="300" > 
        		<tr >
        			...
        			%>
        					<td ><a href="<%=path%>/CourseServlet?operate=allCourseQuery&href=management&pageN=<%=nowPage-1 %>">上一页</a></td>       			
        			<%}%>     			
        			
        			<%
        				for(int i =1;i<=pageNum;i++){       					
        			%>                                                       
                    <td ><a href="<%=path%>/CourseServlet?operate=allCourseQuery&href=management&pageN=<%=i %>"><%=i %></a></td>
                    <%} %>
        			...
        			%>
        					<td ><a href="<%=path%>/CourseServlet?operate=allCourseQuery&href=management&pageN=<%=nowPage+1 %>">下一页</a></td>       			
        			<%}%>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href="<%=path%>/manager/courseInfoManagement.jsp#" class="go-top">
