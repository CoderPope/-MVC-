...
<html lang="en">
  ...
  <body>        
  		<%
       		...
       		if(CnoList==null){
       			response.sendRedirect(""+path+"/CourseServlet?operate=queryCno&href=major");
			
       		}
       		else{
      	%>     
          	<h3><i class="fa fa-angle-right"></i> 添加专业：</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      ...
                      <h4><i class="fa fa-angle-right"></i>输入信息：</h4>
                          ...
                          <input type="hidden" name="operate" value="majorInfoInsert"/>
