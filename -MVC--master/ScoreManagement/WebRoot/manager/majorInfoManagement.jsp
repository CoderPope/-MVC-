  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="<%=path%>/MajorServlet?operate=majorInfo">专业信息管理</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <%
       ...
       ArrayList allMajorList = (ArrayList)request.getAttribute("allMajorList");
       if(allMajorList==null){
       		response.sendRedirect(""+path+"/MajorServlet?operate=majorInfo");
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 专业信息管理：</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <form action="<%=path%>/MajorServlet">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <%
         						...
         						Major majorInfo = (Major)allMajorList.get(i); 
         					  %>
                              <tr>
                              	  <td class="numeric"><input type="checkbox" name="ids" value="<%=majorInfo.getCno()%>"/></td>                            	  
                              	  <td class="numeric"><%=majorInfo.getCno() %></td>
                              	  <td class="numeric"><%=majorInfo.getCname() %></td>
                                  <td class="numeric"><%=majorInfo.getMajor() %></td>                                  
                                  <td class="numeric"><span class="badge bg-theme04"><i class="fa fa-trash-o "><a href="<%=path%>/MajorServlet?operate=delete&Cno=<%=majorInfo.getCno()%>">删除</a></i></span></td>
                              </tr>
                              <%} %>
                                                         
                              </tbody>
                          </table>
                          <span class="btn btn-warning btn-lg"><a href="<%=path%>/MajorServlet?operate=updateQuery">批量修改</a></span>
        	...
        	<table  align="right" width="300" > 
        		<tr >
        			...
        			%>
        					<td ><a href="<%=path%>/MajorServlet?operate=majorInfo&pageN=<%=nowPage-1 %>">上一页</a></td>       			
        			<%}%>     			
        			
        			<%
        				for(int i =1;i<=pageNum;i++){       					
        			%>                                                       
                    <td ><a href="<%=path%>/MajorServlet?operate=majorInfo&pageN=<%=i %>"><%=i %></a></td>
                    <%} %>
        			...
        			%>
        					<td ><a href="<%=path%>/MajorServlet?operate=majorInfo&pageN=<%=nowPage+1 %>">下一页</a></td>       			
        			<%}%>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href=""+path+"/manager/majorInfoQuery.jsp#" class="go-top">
