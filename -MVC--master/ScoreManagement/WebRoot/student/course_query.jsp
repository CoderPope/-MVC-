  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
				  ...
				  <li class="sub-menu">
                      <a class="active" href="<%=path %>/student/course_query.jsp">
                          <i class="fa fa-th"></i>
                          <span>课程查询</span>
                      </a>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <% 
       ...
       if(courseList==null){
       		response.sendRedirect(""+path+"/CourseServlet?operate=course_query&major="+studentInfo.getMajor()+"");
       }
       else{
       		int pageSize = 10;
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 已选课程：</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <%
         					  ...
         					  %>
                              <tr>
                                  <td class="numeric"><%=course.getCno() %></td>
                                  <td class="numeric"><%=course.getCname() %></td>
                                  <td class="numeric"><%=course.getCredit() %></td>
                                  <td class="numeric"><%=course.getType() %></td>
                              </tr>
                              <%} %>
        	...
        	<table  align="right" width="300" > 
        		<tr >
        			...
        			%>
        					<td ><a href="<%=path %>/CourseServlet?operate=course_query&major=<%=studentInfo.getMajor()%>&pageN=<%=nowPage-1 %>">上一页</a></td>       			
        			<%}%>     			
        			
        			<%
        				for(int i =1;i<=pageNum;i++){       					
        			%>                                                       
                    <td ><a href="<%=path %>/CourseServlet?operate=course_query&major=<%=studentInfo.getMajor()%>&pageN=<%=i %>"><%=i %></a></td>
                    <%} %>
        			...
        			%>
        					<td ><a href="<%=path %>/CourseServlet?operate=course_query&major=<%=studentInfo.getMajor()%>&pageN=<%=nowPage+1 %>">下一页</a></td>       			
        			<%}%>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href=""+path+"/student/course_query.jsp#" class="go-top">
