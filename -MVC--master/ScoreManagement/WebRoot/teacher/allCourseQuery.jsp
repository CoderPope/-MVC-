          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<%=path %>/tacher/temp.jsp?Cno=<%=teacherInfo.getCno()%>">成绩审查</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a class="active" href="<%=path %>/CourseServlet?operate=allCourseQuery&herf=teacher">
                          <i class="fa fa-th"></i>
                          <span>全校课程查询</span>
                      </a>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <%
       ...
       if(allCourseList==null){
       		response.sendRedirect(""+path+"/CourseServlet?operate=allCourseQuery&href=teacher");
       }
       else{
      %>    
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 已开课程：</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <%
         						...
         						Course allCourse = (Course)allCourseList.get(i); 
         					  %>
                              <tr>
                                  <td class="numeric"><%=allCourse.getCno() %></td>
                                  <td class="numeric"><%=allCourse.getCname() %></td>
                                  <td class="numeric"><%=allCourse.getCredit() %></td>
                                  <td class="numeric"><%=allCourse.getType() %></td>
                              </tr>
                              <%} %>
        	...
        	<table  align="right" width="300" > 
        		<tr >
        			...
        			%>
        					<td ><a href="<%=path %>/CourseServlet?operate=allCourseQuery&href=teacher&pageN=<%=nowPage-1 %>">上一页</a></td>       			
        			<%}%>     			
        			
        			<%
        				for(int i =1;i<=pageNum;i++){       					
        			%>                                                       
                    <td ><a href="<%=path %>/CourseServlet?operate=allCourseQuery&href=teacher&pageN=<%=i %>"><%=i %></a></td>
                    <%} %>
        			...
        			%>
        					<td ><a href="<%=path %>/CourseServlet?operate=allCourseQuery&href=teacher&pageN=<%=nowPage+1 %>">下一页</a></td>       			
        			<%}%>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href=""+path+"/teacher/allCourseQuery.jsp#" class="go-top">
