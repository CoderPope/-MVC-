  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="<%=path %>/ScoreServlet?operate=allScoreQuery">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <%
       ...
       ArrayList allScoreList = (ArrayList)request.getAttribute("allScoreList");
       if(allScoreList==null){
			RequestDispatcher rd = request.getRequestDispatcher(""+path+"/ScoreServlet?operate=allScoreQuery");
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 全部学生成绩：</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                          ...
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                              ...
                              <%
         						...
         						Score allScore = (Score)allScoreList.get(i); 
         					  %>
                              <tr>
                              	  <td class="numeric"><%=allScore.getSno() %></td>
                              	  <td class="numeric"><%=allScore.getSname() %></td>
                                  <td class="numeric"><%=allScore.getCname() %></td>
                                  <td class="numeric"><%=allScore.getType() %></td>
                                  <td class="numeric"><%=allScore.getGrade() %></td>
                              </tr>
                              <%} %>
        	...
        	<table  align="right" width="300" > 
        		<tr >
        			...
        			%>
        					<td ><a href="<%=path %>/ScoreServlet?operate=allScoreQuery&pageN=<%=nowPage-1 %>">上一页</a></td>       			
        			<%}%>     			
        			
        			<%
        				for(int i =1;i<=pageNum;i++){       					
        			%>                                                       
                    <td ><a href="<%=path %>/ScoreServlet?operate=allScoreQuery&pageN=<%=i %>"><%=i %></a></td>
                    <%} %>
        			...
        			%>
        					<td ><a href="<%=path %>/ScoreServlet?operate=allScoreQuery&pageN=<%=nowPage+1 %>">下一页</a></td>       			
        			<%}%>
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href=""+path+"/teacher/allScoreQuery.jsp#" class="go-top">
